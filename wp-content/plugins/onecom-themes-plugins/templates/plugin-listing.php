<div class="wrap">
	...
	<div class="wrap_inner inner one_wrap">
		<div class="nav-tab-wrapper">
			<a href="<?php echo admin_url( 'admin.php?page=onecom-wp-plugins' ); ?>" class="nav-tab nav-tab-active"><?php _e( 'One.com plugins', OC_PLUGIN_DOMAIN); ?></a>
		    <a href="<?php echo admin_url( 'admin.php?page=onecom-wp-recommended-plugins' ); ?>" class="nav-tab"><?php _e( 'Recommended plugins', OC_PLUGIN_DOMAIN); ?></a>
		    <a href="<?php echo admin_url( 'admin.php?page=onecom-wp-discouraged-plugins' ); ?>" class="nav-tab"><?php _e( 'Discouraged plugins', OC_PLUGIN_DOMAIN); ?></a>
		</div>
